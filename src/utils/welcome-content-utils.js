...
export const welcomeContent = [
  {
    header: "About Me",
    textcontent:
      "My name is Sita Robinson. I graduated from Drexel University with a BS in Data Science and minor in Computer Science in 2020. Some of my hobbies include programming, landscape photography, playing the clarinet, playing Scrabble and traveling around the world. I am originally a Northern Virginia/Metro D.C. native.",
  },
  {
    header: "Skills",
    textcontent: (
